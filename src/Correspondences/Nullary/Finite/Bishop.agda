...
instance
  is-fin-set-is-of-hlevel : is-of-hlevel (suc n) (is-fin-set A)
  is-fin-set-is-of-hlevel = is-prop→is-of-hlevel-suc is-fin-set-is-prop
...
instance
  ...
  Σ-is-fin-set {A} {P} ⦃ (afin) ⦄ ⦃ (fam) ⦄ = ∥-∥₁.proj do
    ...
    let
      ...
      fs = fin-sum bc
      work = do
        t ← finite-choice $ enumeration ∘ fam
  ...
  lift-is-fin-set
    : ⦃ is-fin-set A ⦄ → is-fin-set (Lift ℓ′ A)
  lift-is-fin-set = fin do
    aeq ← enumeration it
