...
opaque
  ...
  is-omniscient {ℓ′} A = {P : Pred₁ ℓ′ A} → Decidable ⌞ P ⌟ₚ → Decision (∃[ a ꞉ A ] ⌞ P a ⌟)

  is-omniscient-β : is-omniscient A → {P : Pred₁ ℓ′ A} → Decidable ⌞ P ⌟ₚ → Decision (∃[ a ꞉ A ] ⌞ P a ⌟)
  is-omniscient-β = id

  is-omniscient-η : ({P : Pred₁ ℓ′ A} → Decidable ⌞ P ⌟ₚ → Decision (∃[ a ꞉ A ] ⌞ P a ⌟)) → is-omniscient A
  is-omniscient-η = id

opaque
  unfolding is-omniscient is-decidable-at-hlevel
  is-omniscient-is-prop : is-prop (is-omniscient {ℓ′ = ℓ′} A)
  is-omniscient-is-prop = hlevel!

  opaque
    unfolding is-exhaustible Decidable n-Type-carrier
