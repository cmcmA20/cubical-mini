...
module _ {P : Poset o ℓ} {Q : Poset o′ ℓ′} where
  ...
  ×-is-join : {a b c : ⌞ P ⌟} {x y z : ⌞ Q ⌟}
            → ×-notation (is-join P a b c) (is-join Q x y z) (is-join (P × Q) (a , x) (b , y) (c , z))
  ...
  ×-is-join ._×_ lp lq .is-join.least (ub₁ , ub₂) (al , xl) (bl , yl) = lp .is-join.least ub₁ al bl , lq .is-join.least ub₂ xl yl

  ×-Join : {a b : ⌞ P ⌟} {x y : ⌞ Q ⌟}
         → ×-notation (Join P a b) (Join Q x y) (Join (P × Q) (a , x) (b , y))
  ×-Join .×-notation.Constraint _ _ = ⊤
  ×-Join ._×_ α β .Join.lub      = α .Join.lub , β .Join.lub
  ×-Join ._×_ α β .Join.has-join = ×-is-join ._×_ (α .Join.has-join) (β .Join.has-join)

  ×-is-meet : {a b c : ⌞ P ⌟} {x y z : ⌞ Q ⌟}
            → ×-notation (is-meet P a b c) (is-meet Q x y z) (is-meet (P × Q) (a , x) (b , y) (c , z))
  ...
  ×-is-meet ._×_ lp lq .is-meet.greatest (ub₁ , ub₂) (al , xl) (bl , yl) = lp .is-meet.greatest ub₁ al bl , lq .is-meet.greatest ub₂ xl yl

  ×-Meet : {a b : ⌞ P ⌟} {x y : ⌞ Q ⌟}
         → ×-notation (Meet P a b) (Meet Q x y) (Meet (P × Q) (a , x) (b , y))
  ×-Meet .×-notation.Constraint _ _ = ⊤
  ×-Meet ._×_ α β .Meet.glb      = α .Meet.glb , β .Meet.glb
  ×-Meet ._×_ α β .Meet.has-meet = ×-is-meet ._×_ (α .Meet.has-meet) (β .Meet.has-meet)
