...
module RezkByYoneda (C : Category ℓ ℓ) where
  ...
  @0 isUnivalentYonedaImage : isUnivalent YonedaImage
  ...
  @0 isWeakEquivalenceToYonedaImage : isWeakEquivalence ToYonedaImage
  ...
  @0 isRezkCompletionToYonedaImage : isRezkCompletion ToYonedaImage
