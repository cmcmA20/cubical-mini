...
module _ {C : Category ℓC ℓC'} (monadM : Monad C) where
  ...
  @0 ForgetEM : Functor EMCategory (AlgebrasCategory M)
  ForgetEM = FullInclusion (AlgebrasCategory M) IsEMAlgebra

  @0 ForgetEMAlgebra : Functor EMCategory C
  ...
  @0 ForgetFreeEMAlgebra : funcComp ForgetEMAlgebra FreeEMAlgebra ≡ M
...
module _ {C : Category ℓC ℓC'} {monadM monadN : Monad C} (monadν : MonadHom monadM monadN) where
  ...
  @0 EMFunctor : Functor (EMCategory monadN) (EMCategory monadM)
