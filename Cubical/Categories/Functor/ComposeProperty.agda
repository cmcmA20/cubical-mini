...
module _ {ℓC ℓC' ℓD ℓD' ℓE ℓE'}
  ...
  @0 isEssSurj+Full→isFullyFaithfulPrecomp : isEssentiallySurj F → isFull F → isFullyFaithful (precomposeF E F)
...
module _ {ℓC ℓC' ℓD ℓD' ℓE ℓE'}
  ...
  @0 isWeakEquiv→isWeakEquivPrecomp : isWeakEquivalence F → isWeakEquivalence (precomposeF E F)
  ...
  @0 isWeakEquiv→isEquivPrecomp : isWeakEquivalence F → isEquivalence (precomposeF E F)
