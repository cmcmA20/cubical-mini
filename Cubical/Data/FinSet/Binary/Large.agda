...
@0 structure₀ : BinStructure (Binary ℓ-zero)
...
module Parameterized (B : Type ℓ) where
  ...
  @0 Loopᴾ : (P Q : Bool ≃ B) → Baseᴾ P ≡ Baseᴾ Q
  Loopᴾ P Q i = λ where
      .fst → ua first i
  ...
  @0 Loopᴾ² : (P Q R : Bool ≃ B) → Square (Loopᴾ P Q) (Loopᴾ P R) refl (Loopᴾ Q R)
