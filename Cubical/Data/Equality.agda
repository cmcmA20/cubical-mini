...
@0 PathPathEq : {x y : A} → Path _ (Path A x y) (x ≡ y)
PathPathEq = isoToPath PathIsoEq

@0 Path≡Eq : {x y : A} → (Path A x y) ≡ (x ≡ y)
