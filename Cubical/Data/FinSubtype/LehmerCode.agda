...
@0 isEquivPunchOut : {i : Fin (suc n)} → isEquiv (punchOut i)
...
@0 punchOutEquiv : {i : Fin (suc n)} → FinExcept i ≃ Fin n
...
@0 encode : (Fin n ≃ Fin n) → LehmerCode n
encode = equivFun lehmerEquiv

@0 decode : LehmerCode n → Fin n ≃ Fin n
