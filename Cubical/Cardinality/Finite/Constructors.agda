...
module _
  ...
  @0 isFinSetΣ : isFinSet (Σ (X .fst) (λ x → Y x .fst))
  ...
  @0 isFinSetΠ : isFinSet ((x : X .fst) → Y x .fst)
...
module _
  ...
  @0 isFinSetΠ2 : isFinSet ((x : X .fst) → (y : Y x .fst) → Z x y .fst)
...
module _
  ...
  @0 isFinSetΠ3 : isFinSet ((x : X .fst) → (y : Y x .fst) → (z : Z x y .fst) → W x y z .fst)
...
module _
  ...
  @0 isFinSet→ : isFinSet (X .fst → Y .fst)
...
module _
  ...
  @0 isFinSetType≡ : isFinSet (X .fst ≡ Y .fst)
